...
echo
sleep 1
echo "$bi"Nomor "$i"["$me" 1 "$i"] "$i" ☆"$pu" Install bahan bahan "$i" ☆
echo "$bi"Nomor "$i"["$me" 2 "$i"] "$i" ☆"$pu" Auto like dan komen "$i" ☆
echo "$bi"Nomor "$i"["$me" 3 "$i"] "$i" ☆"$pu" Ambil token "$i" ☆
echo "$bi"Nomor "$i"["$me" 4 "$i"] "$i" ☆"$pu" Profil Guard facebook "$i" ☆
echo "$bi"Nomor "$i"["$me" 5 "$i"] "$i" ☆"$pu" Keluar "$i" ☆
echo
...
clear
echo membuka program mohon tunggu sebentar
sleep 3
clear
sh firdaus.sh
fi
...
then
clear
echo membuka program Like dan komen
echo mohon tunggu bos
sleep 3
echo loading...
sleep 2
clear
